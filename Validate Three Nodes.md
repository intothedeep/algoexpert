...
O(d), O(1), d is distance between node 1 and node 3
...
function validateThreeNodes(nodeOne, nodeTwo, nodeThree) {
    ...
    while (true) {
        ...
        if (search1 !== null) {
            search1 =
                search1.value > nodeTwo.value ? search1.left : search1.right;
        }
        if (search3 !== null) {
            search3 =
                search3.value > nodeTwo.value ? search3.left : search3.right;
        }
    }

    const is13equal = search1 === nodeThree || search3 === nodeOne;
    const foundNodeTwo = search1 === nodeTwo || search3 === nodeTwo;
    if (is13equal || !foundNodeTwo) return false;
