- Levenshtein Distance
  ![Screenshot 2023-01-22 at 23.35.47.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/888ba02e-7083-4958-8bd3-14a05ab787c8/Screenshot_2023-01-22_at_23.35.47.png)
  - n x m, n x m
  ```jsx
  function levenshteinDistance(str1, str2) {
    ...
    for (let i = 1; i < str1.length + 1; i++) {
      for (let j = 1; j < str2.length + 1; j++) {
        ...
        edits[i][j] =
          Math.min(edits[i - 1][j], edits[i][j - 1], edits[i - 1][j - 1]) + 1;
      }
    }
    console.log(edits);
